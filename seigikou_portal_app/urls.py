...
urlpatterns = [
    ...
    path('create2/',views.MemberCreateView.as_view(),name='create2'),         #新規登録画面(メンバー)
    ...
    path('create3/',views.KouenCreateView.as_view(),name='create3'),         #新規登録画面(講演)
    path('update/<int:pk>/',views.EventUpdateView.as_view(),name='update'),   #更新画面(イベント)
    path('update2/<int:pk>/',views.MemberUpdateView.as_view(),name='update2'),   #更新画面(メンバー)
    path('update3/<int:pk>/',views.KouenUpdateView.as_view(),name='update3'),   #更新画面(講演)
